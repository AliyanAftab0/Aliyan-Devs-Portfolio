          ...
          <div className="flex flex-col gap-[1.5rem]">
            <div>
              ...
              <h1 className="text-4xl">
                Have a <span className="text-blue-600">Project</span> or want to{" "}
                <br />
            ...
            <div className="border-2 rounded-md dark:bg-slate-900 shadow-2xl p-6 dark:shadow-slate-800 shadow-slate-400">
              <div>
              ...
              <div>
                ...
                <p className="text-xl">aliyandev0@gmail.com</p>
              </div>
              <div>
                <p className="text-xl">Follow on</p>
                <span className="flex my-3 gap-5 cursor-pointer">
                  <Link href="https://www.instagram.com/aliyandev/">
                    <Image
                      src={Instagram}
                      alt="Instagram"
                      width={32}
